...
$normalizedCaseTableName="autonormalized".$domainName;
...
#$queryCases="Select * from ".$caseTableName;
#$queryCases="Select sno,caseTitle from predixstackoverflow";
$queryCases="SELECT `id`,`description` FROM `smartsignal_jim_allfields` where id>5527";
